...
import sprite1 from './assets/sprites/sprite3.png'
import sprite2 from './assets/sprites/sprite2.png'
import sprite3 from './assets/sprites/sprite1.png'
import sprite4 from './assets/sprites/sprite0.png'
...
function StatButton({ icon, statName, onClick }) {
  return (
    <button
      ...
      className="w-[70px] h-[70px] p-[8px] flex items-center justify-center bg-transparent rounded-[15px] border-3 border-[#D92211]"
    >
...
function App() {
  ...
  return (
    <div className="w-screen h-screen relative flex items-center justify-center">
      <div
        id="home"
        className="w-full max-w-[300px] h-[600px] flex flex-col items-center bg-gradient-to-b from-[#E83E2E] to-[#91161E] overflow-hidden rounded-2xl"
      >
